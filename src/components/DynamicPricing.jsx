...
function DynamicPricing() {
  ...
  function changePrice(value) {
    ...
    setAmount(
      billing === "yearly"
        ? (Number(amounts[value - 1]) / 4).toString()
        : amounts[value - 1]
    );
  }
  return (
    <div className="dynamicPricing">
      <div className="dynamicPricing-pricing">
        <p className="pricing-pageViews">{pageView} PAGEVIEWS</p>
        {!isSmall && (
          <p className="pricing-package">
            <span className="pricing-amount">${amount}.00</span>
